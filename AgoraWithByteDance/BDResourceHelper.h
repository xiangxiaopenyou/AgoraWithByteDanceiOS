...
static NSString *const FACE_MODEL = @"/ttfacemodel/tt_face_v8.2.model";
static NSString *const FACE_MODEL_EXTRA = @"/ttfacemodel/tt_face_extra_v11.0.model";
static NSString *const FACE_ATTRIBUTE_MODEL = @"/ttfaceattrmodel/tt_face_attribute_v6.1.model";
static NSString *const FACE_VERIFY_MODEL = @"/ttfaceverify/tt_faceverify_v5.0.model";
static NSString *const SKELETON_MODEL = @"/skeleton_model/tt_skeleton_v6.0.model";
static NSString *const HAND_DET_MODEL = @"/handmodel/tt_hand_det_v9.0.model";
static NSString *const HAND_GESTURE_MODEL = @"/handmodel/tt_hand_gesture_v8.1.model";
...
static NSString *const HAND_BOX_MODEL = @"/handmodel/tt_hand_box_reg_v10.0.model";
static NSString *const HAIR_PARSER_MODEL = @"/hairparser/tt_hair_v9.0.model";
...
static NSString *const HUMAN_DISTANCE_MODEL = @"/humandistance/tt_humandist_v1.0.model";
static NSString *const GENERAL_OBJECT_MODEL = @"/generalobjectmodel/tt_general_obj_detection_v1.0.model";
static NSString *const GENERAL_OBJECT_CLS_MODEL = @"/generalobjectmodel/tt_general_obj_detection_cls_v1.0.model";
static NSString *const GENERAL_OBJECT_TRACK_MODEL = @"/generalobjectmodel/tt_sample_v1.0.model";
