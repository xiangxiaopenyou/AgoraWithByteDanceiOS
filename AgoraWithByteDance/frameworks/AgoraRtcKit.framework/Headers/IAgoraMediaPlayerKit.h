...
struct MediaPlayerContext {
  ...
  MediaPlayerContext() : context(NULL) {}
};
 ...
 *
 */
class IMediaPlayerKit {
 protected:
  virtual ~IMediaPlayerKit() {}
 ...
 */
AGORA_PLAYER_API agora::rtc::IMediaPlayerKit* AGORA_PLAYER_CALL createAgoraMediaPlayerKit();
