...
typedef NS_ENUM(NSInteger, AgoraChannelProfile) {
     ...
     * 2: Gaming.
     *
     * This profile uses a codec with a low bitrate and consumes less power. Applies to the gaming scenario,
     * where all game players can talk freely.
     */
...
typedef NS_ENUM(NSUInteger, AgoraVideoRemoteState) {
    /** The remote video is in the initial state */
    AgoraVideoRemoteStateStopped = 0,
    /** The remote video packet is received, but not decoded. */
    AgoraVideoRemoteStateStarting = 1,
    /** The remote video stream is decoded and plays normally */
    AgoraVideoRemoteStateDecoding = 2,
    /** The remote video is frozen, probably due to some network issue */
    AgoraVideoRemoteStateFrozen = 3,
    /** The remote video fails to start */
...
typedef NS_ENUM(NSInteger, AgoraAudioProfile) {
    ...
    /** Sampling rate 32 kHz, audio encoding, single channel, and bitrate up to 18 kbit/s. */
    AgoraAudioProfileSpeechStandard = 1,
    /** Sampling rate 48 kHz, music encoding, single channel, and bitrate up to 48 kbit/s. */
    AgoraAudioProfileMusicStandard = 2,
    /** Sampling rate 48 kHz, music encoding, dual-channel, and bitrate up to 56 kbit/s. */
    AgoraAudioProfileMusicStandardStereo = 3,
    /** Sampling rate 48 kHz, music encoding, single channel, and bitrate up to 128 kbit/s. */
    AgoraAudioProfileMusicHighQuality = 4,
    /** Sampling rate 48 kHz, music encoding, dual-channel, and bitrate up to 192 kbit/s. */
...
typedef NS_ENUM(NSInteger, AgoraVideoSourceType) {
   ...
   */
  AgoraVideoSourceTypeMediaPlayer = 4,
  /** Video for custom video.
   */
  AgoraVideoSourceTypeCustom = 5,
  /** Video for png image.
   */
 ...
 *
 */
typedef NS_ENUM(NSInteger, AgoraMediaPlayBackSpeed) {
  /** original playback speed
   */
  AgoraMediaPlayBackSpeedOriginal = 100,
  /** playback speed slow down to 0.5
   */
  AgoraMediaPlayBackSpeed50Percent = 50,
  /** playback speed slow down to 0.75
   */
  AgoraMediaPlayBackSpeed75Percent = 75,
  /** playback speed speed up to 1.25
   */
  AgoraMediaPlayBackSpeed125Percent = 125,
  /** playback speed speed up to 1.5
   */
  AgoraMediaPlayBackSpeed150Percent = 150,
  /** playback speed speed up to 2.0
   */
  AgoraMediaPlayBackSpeed200Percent = 200,
};
...
typedef NS_ENUM(NSInteger, AgoraMediaPlayerState) {
  ...
  /** Player stopped
   */
  AgoraMediaPlayerStateStopped = AgoraMediaPlayerStateIdle,
