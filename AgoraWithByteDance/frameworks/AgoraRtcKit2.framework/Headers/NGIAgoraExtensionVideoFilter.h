...
class IExtensionVideoFilterEventDelegate {
public:
  virtual ~IExtensionVideoFilterEventDelegate() = default;
...
public:
  ...
  virtual bool setEventDelegate(IExtensionVideoFilterEventDelegate* delegate) = 0;
...
using ExtensionVideoFilterEventDelegateDeleter = void(*)(IExtensionVideoFilterEventDelegate*);
}
}
