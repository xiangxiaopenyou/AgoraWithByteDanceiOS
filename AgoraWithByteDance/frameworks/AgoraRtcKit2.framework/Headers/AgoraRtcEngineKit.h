 ...
 * - When exceptions occur during playback, this callback returns 714 in `state` and an error code in `errorCode`.
 *
 * @param engine  The AgoraRtcEngineKit object.
 * @param state  {@link AgoraAudioMixingStateType}
 * @param errorCode  {@link AgoraAudioMixingErrorType}
 */
